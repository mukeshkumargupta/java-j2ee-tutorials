...
{ 
    ...
    { 
        ...
        // t1 t3 finishes before t2 
        t1.join(); 
        t3.join();
        t2.join();
        System.out.println("Mainexitedafterjoin");
    } 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                // can wake up. 
                //notify(); //using this one thread will never terminates.
                notifyAll();
                System.out.println("Afternotify "+ Thread.currentThread().getName());
