...
class Cricketer implements Comparable<Cricketer> {
	...
	public int compareTo(Cricketer that) {
		//Tricky : Remember in such a way like if it is asking to descending order
		//means if if first is bigger then return -1
...
public class CollectionExamples {
	public static void main(String[] args) {
		...
		System.out.println("Sorting Cricketer score in descending order:" + cricketers);
		System.out.println(cricketers);
		...
		Collections.sort(cricketers, new Comparator<Cricketer>() {
			...
			@Override
			public int compare(Cricketer cr1, Cricketer cr2) {
				if (cr1.runs > cr2.runs) {
					return -1;
				} else if (cr1.runs < cr2.runs) {
					return 1;
				} else {
					return 0;
				}
		...
		numbers1.add("three");
		numbers1.add("four");
		System.out.println("Printing List element" + numbers1);//Note, In list you can give direct list in println
		...
		System.out.println("Printing array element" + Arrays.toString(numbers1ObjArray));
		//System.out.println("Printing array element" + numbers1ObjArray);//Note it will print address
		// [one, two, three, four]
		...
		System.out.println("Default Tree Map Order: " + treeMapOrig);
		...
		NavigableMap<Integer, Cricketer> treeMapDesc = treeMapOrig
				.descendingMap();
		System.out.println("Descending order:" + treeMapDesc);
		...
		// peek method get the element with highest priority.  Imp
		System.out.println(priorityQueue.peek());// 9
		// peek method does not change the queue
		System.out.println(priorityQueue);// [9, 24, 15, 45]

		// poll method gets the element with highest priority.  Imp
		System.out.println(priorityQueue.poll());// 9
		// poll method removes the highest priority element from the queue.
